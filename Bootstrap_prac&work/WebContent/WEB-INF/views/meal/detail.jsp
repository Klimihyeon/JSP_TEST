				...
				<div class="card card-outline card-info">
					...
					<div class="card-body">
						...
						<div class="card-footer text-center">
							<label for ="price">주문 수량<input type="number" class="form-control" id="price" value=""/></label>
							
							<button type="button" id="modifyBtn" class="btn btn-warning" onclick="">주문하기</button>	
												
						    <button type="button" id="removeBtn" class="btn btn-danger" onclick="">장바구니담기</button>
					    </div>						
					</div>													
				</div><!-- end card -->				
			</div><!-- end col-md-12 -->
