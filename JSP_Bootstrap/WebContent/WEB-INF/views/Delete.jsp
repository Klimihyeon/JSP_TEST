		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a
							href="<%=request.getContextPath()%>/list" class="nav-link"> <i
					...
					<div class="row col-12">
						<div class="card card-info col-12">
							<div class="card-header">
								<h3 class="card-title">회원 아이디 삭제를 원하시면 id와 pass를 입력해주세요.</h3>
							</div>
							<!-- /.card-header -->
							<!-- form start -->
							<form class="form-horizontal" method="post">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="password" class="form-control"
												id="inputPassword3" placeholder="Password" name="pass">
										</div>
									</div>
									<div class="form-group row">
										<div class="offset-sm-2 col-sm-10">
											<div class="form-check">
												<input type="checkbox" class="form-check-input"
													...
													for="exampleCheck2">진짜로 삭제합니다.</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-footer">
									...
									<button type="reset" class="btn btn-default float-right">취소하기</button>
								</div>
								<!-- /.card-footer -->
							</form>
						</div>
