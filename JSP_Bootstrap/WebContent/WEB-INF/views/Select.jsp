							...
							<div class="card">
								...
								<div class="card-body p-0">
									...
									<div class="subheading mb-5">
										<a class="btn btn-block btn-info btn-lg" href="update?id=${memberVO.id }">회원정보 수정하기</a>
										<a class="btn btn-block btn-danger btn-lg" href="delete?id=${memberVO.id }">회원정보
											삭제하기</a>
									</div>
								</div>
								<!-- /.card-body -->
