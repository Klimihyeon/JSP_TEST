					...
					<div class="input-group col-md-12">
						<div class="col-md-12" style="text-align: center;">
							...
							<div class="input-group input-group-sm">
								<label for="inputFile" class=" btn btn-warning btn-sm btn-flat input-group-addon" onclick="upload_go();">사진변경</label>
								<input id="inputFileName" class="form-control" type="text" name="tempPicture" disabled
									value="${member.picture.split('\\$\\$')[1] }"/>
								<input id="pictureFile" class="form-control" type="hidden" name="uploadPicture" />
							</div>						
						</div>												
					</div>
				</div>	
